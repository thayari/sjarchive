				...
				<tr>				
					<td>
						...
						<div class="text-center">
							...
							<?php else: ?>
								<?php $link['ftype']='pdf';?>
							<a style="width: 25px;   margin: 20px; background: url('https://image.flaticon.com/icons/svg/80/80942.svg') no-repeat; padding-left: 25px;" href="<?php echo (JRoute::_($link ));?>">
